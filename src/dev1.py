...
pathlib.Path(f'./results/hiersup/try_8/{len(self.superpixels)}/').mkdir(exist_ok=True, parents=True)

plt.imsave(f'./results/hiersup/try_8/{len(self.superpixels)}/sp.png', self.superpixels.array_means, cmap='gray')
plt.imsave(f'./results/hiersup/try_8/{len(self.superpixels)}/img.png', self.superpixels.img_ini, cmap='gray')

p.plot_img_mask_on_ax(ax, self.superpixels.array_means, self.superpixels.infer_superpixel_edges())
fig.savefig(f'./results/hiersup/try_8/{len(self.superpixels)}/sp_frontier.png')

p.plot_img_mask_on_ax(ax, self.superpixels.img_ini, self.superpixels.infer_superpixel_edges())
fig.savefig(f'./results/hiersup/try_8/{len(self.superpixels)}/img_frontier.png')
...
ax.grid(True)
fig.savefig('./results/hiersup/try_8/nei_time.png')
...
ax.set_yscale('log')
fig.savefig('./results/hiersup/try_8/time_weights.png')

fig, ax = plt.subplots(1, 1, figsize=(8, 8))
ax.plot(self.time_update)
ax.set_yscale('log')
fig.savefig('./results/hiersup/try_8/time_update.png')


fig, ax = plt.subplots(1, 1, figsize=(8, 8))
ax.plot(self.time_merge)
ax.set_yscale('log')
fig.savefig('./results/hiersup/try_8/time_merge.png')

fig, ax = plt.subplots(1, 1, figsize=(8, 8))
ax.plot(self.time_step)
ax.set_yscale('log')
fig.savefig('./results/hiersup/try_8/time_step.png')
...
ax.legend()
ax.grid(True)
fig.savefig('./results/hiersup/try_8/time_tot.png')


fig, ax = plt.subplots(1, 1, figsize=(8, 8))
ax.plot(self.nb_neighbors)
fig.savefig('./results/hiersup/try_8/nb_neighbors.png')
...
fig.savefig('./results/hiersup/try_8/weights_pop_time.png')
...
ax.set_xscale('log')
ax.grid(True)
fig.savefig('./results/hiersup/try_8/nb_weights_pop.png')
